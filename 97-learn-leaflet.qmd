...
A complete different approach that comes to my mind is using interactive control via {**shiny**}. (See my [shiny section](https://bookdown.org/pbaumgartner/geocomputing-notes/09-making-maps.html#shiny).)
