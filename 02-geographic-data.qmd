...
-   `r glossary("PROJ")`, a powerful library for coordinate system
    ...
    [@evenden-2024].
-   `r glossary("GEOSx", "GEOS")`, a planar geometry engine for operations such
...
### Introduction to {**terra**} {#sec-02-intro-terra}
...
pb_create_folder("data/chapter02")

terra::writeRaster(
  multi_rast,
  "data/chapter02/landsat.tif",
  overwrite = TRUE,
  datatype = "FLT4S"
  ) 
...
multi_rast <- terra::rast("data/chapter02/landsat.tif")
